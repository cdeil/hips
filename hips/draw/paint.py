...
from ..tiles import HipsSurveyProperties, HipsTile, HipsTileFetcher
...
class HipsPainter:
    ...
    def tiles(self) -> List[HipsTile]:
        ...
        tile_fetcher = HipsTileFetcher(self.tile_indices, self.draw_hips_order, self.hips_survey,
                                       self.tile_format, self.progress_bar)
        if self._tiles is None:
            if self.fetch_package == 'aiohttp':
                self._tiles = tile_fetcher.tiles_aiohttp
